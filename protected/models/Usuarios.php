...
class Usuarios 
{
	 ...
	 */
	public $PERS_ID, $PERS_IDENTIFICACION, $PERS_EMAIL, $PENA_NOMBRES, $PENA_APELLIDOS;
	...
	public function rules()
	{
		...
		return array(
			...
			USUA_ULTIMOACCESO, USES_ID, PENA_ID', 'required'),
			...
			USUA_FECHABAJA, USUA_ULTIMOACCESO, USES_ID, PERS_ID, PERS_IDENTIFICACION, 
	...
	public function search()
	{
		...
		$criteria->select='p.PERS_ID, p.PERS_IDENTIFICACION, p.PERS_EMAIL, pn.PENA_NOMBRES, pn.PENA_APELLIDOS,
		t.*';
		$criteria->join ='
	...
	public function getDatosUsuario($id)
	{
	 ...
	 FROM TBL_PERSONAS  p, TBL_PERSONASNATURALES pn, TBL_USUARIOS u
	 WHERE pn.PERS_ID = p.PERS_ID AND u.PENA_ID = pn.PENA_ID AND u.USUA_ID = $id LIMIT 1";
